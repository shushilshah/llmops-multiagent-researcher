...
def load_session(session_id: str) -> dict | None:
    """Load a research session from MongDB."""
    db = get_db()
    ...
    if session:
        print(f"[Memory] session {session_id} loaded from MongoDB")
